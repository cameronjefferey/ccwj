...
def init_db():
    ...
    statements = [
        ...
        """,
        # LEGACY (Aug 2026 surface audit): the community feature was removed.
        # user_follows / community_published_trades / community_posts stay in
        # the schema so existing rows survive until a deliberate drop
        # migration; no code reads or writes them anymore.
        """
