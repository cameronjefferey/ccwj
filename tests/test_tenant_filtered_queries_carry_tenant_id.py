...
FILTERED_QUERIES = [
    ...
    ("app.symbols_page", "OPEN_SESSION_START_QUERY"),
    ("app.symbols_page", "CLOSED_LEGS_QUERY"),
    ("app.symbols_page", "CLOSED_EQUITY_LEGS_QUERY"),
    ("app.symbols_page", "CURRENT_POSITIONS_QUERY"),
    ("app.symbols_page", "STRATEGIES_MAP_QUERY"),
    ("app.symbols_page", "SYMBOLS_PNL_QUERY"),
