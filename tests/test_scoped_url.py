...
def test_fill_and_weekly_trade_drills_pin_row_tenant():
    ...
    # "Trades this week" now renders inside the deferred /overview/below
    # partial (skeleton-first X-HT-Full split), not weekly_review.html
    # directly.
    overview = (templates / "_overview_below.html").read_text()
